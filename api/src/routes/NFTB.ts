...
import * as schema from "../schema/NFTB";
import { NFTB } from "../models";

export const router = express.Router();

router.post("/", validateSchema(schema.CreateNFTBSchema), async (req: schema.ICreateNFTBSchema, res, next) => {
