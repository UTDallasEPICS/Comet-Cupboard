...
div.px-5.overflow-y-scroll.overscroll-contain
	div.flex.flex-col.sm_flex-row.justify-center.items-center.sm_space-x-10.mt-7.mb-12
		div.relative.z-10.flex.flex-col.max-w-52.max-h-52.min-w-52.min-h-52.bg-gray-300.items-center.justify-center.rounded.cursor-pointer.drop-shadow-standard
