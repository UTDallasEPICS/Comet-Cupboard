<template lang="pug">
  div.p-4.w-72(v-if="typeOfCard === 'inventory'")
    div.relative
      div.flex.justify-center
        img.w-250.h-250.shadow-md.object-cover.rounded-md(:src="imgURL" :alt="name")
    ...
    div.flex.justify-center.items-center.mt-2
      div.border.border-utd-orange.shadow-md.rounded-l-full.px-7.py-1.flex.items-center
        span.text-sm.font-semibold.text-black {{ currentCount }}
      div.border.border-utd-orange.bg-utd-orange.border-l-0.bg-opacity-20.shadow-md.rounded-r-full.px-7.py-1.flex.items-center
        span.text-sm.font-semibold.text-utd-orange +{{ change || '0' }}

    div.flex.justify-center.items-center.space-x-6.mt-3
      ...
      div.text-xl.font-semibold.text-gray-900.border-b-2.border-black.w-10.flex.justify-center {{ '1' }}
  ...
  div.p-4.w-72(v-if="typeOfCard === 'shopping'")
    div.flex.justify-center
      img.w-250.h-250.shadow-md.object-cover.rounded-md(:src="imgURL" :alt="name")    
