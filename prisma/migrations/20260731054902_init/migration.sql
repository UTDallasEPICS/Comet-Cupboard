...
CREATE TABLE "auth_session" (
    ...
    "ip_address" TEXT,
    "user_agent" TEXT,
    CONSTRAINT "auth_session_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user" ("userID") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "emergency_bag" (
    ...
    "locationName" TEXT,
    "bag_category" TEXT NOT NULL DEFAULT 'NEITHER',
