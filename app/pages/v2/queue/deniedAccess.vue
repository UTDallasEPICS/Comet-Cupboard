<template lang="pug">
//- Denied Access Page: Page for if the student is denied access to the Comet Cupboard
div
	//- Header for the Denied Access page.
	div.flex.absolute.top-20.left-0.w-full.h-16.z-30.justify-center
		V2SharedHeaderSubheader(pageTitle="Denied Access")(class="md_max-w-[600px]").md_rounded-b-xl
	
	div(class="w-11/12 lg_w-6/12").mx-auto.mt-20
