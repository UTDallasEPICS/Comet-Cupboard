...
div
	...
	div(class="w-11/12 lg_w-6/12").mx-auto
		...
		div.w-full.rounded-lg.bg-white.font-montserrat.flex.items-center.justify-center.mx-auto.rounded-xl.text-center.text-md.sm_text-3xl.h-80.lg_h-96.mt-4.drop-shadow-standard.p-2
			p Are you sure you want to delete<br><span class="font-semibold">{{ state.deleteSourceName }}</span> ?
		...
		div.w-full.flex.flex-row.mt-3.lg_mt-8.mx-auto.h-11.sm_h-16.mb-2
			...
			button(@click="removeSource").bg-utd-orange.flex.items-center.justify-center.text-base.sm_text-xl.font-semibold.font-montserrat.text-white.rounded-xl.w-32.sm_w-52.p-2.h-full.ml-auto.remove-button-effects
				p Yes, Delete
</template>
