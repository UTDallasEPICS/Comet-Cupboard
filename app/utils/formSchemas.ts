...
export const tutorialNameSchema = z.object({
	name: nameSchema("Tutorial name"),
})

export type TutorialNameForm = z.infer<typeof tutorialNameSchema>

export const tutorialNameFormFields = {
	name: { id: "name", label: "Tutorial Name", description: "Use up to 100 letters and common punctuation", placeholder: "Enter tutorial name" },
...
export const categoryNameSchema = nameSchema("Category name")
