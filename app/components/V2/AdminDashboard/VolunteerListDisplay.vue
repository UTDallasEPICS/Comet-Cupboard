...
div.min-w-72.rounded-2xl.bg-white
    ...
    div(class="lg_w-[600px]").flex.flex-row.justify-center.mx-auto.h-7.lg_h-12.gap-3.w-60
        ...
        button(@click="assignVolunteer").bg-utd-green.font-semibold.font-montserrat.text-white.flex.items-center.justify-center.h-full.text-base.lg_text-3xl.rounded-xl.w-auto.p-2.remove-button-effects
            p + Add
