...
import {PencilIcon} from '@heroicons/vue/24/solid';//Pencil icon used for the Edit button

//Router used for navigating to the page for editing fields fo the specified source.
