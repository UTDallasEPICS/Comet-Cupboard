<template lang="pug">
div.bg-white.h-24.rounded-xl.drop-shadow-standard.relative(class="w-[328px]")
    // Settings/options button
    Menu
        template(#default="{ open }")
            MenuButton.absolute.top-1.right-2.w-8.h-4.content-center.rounded-full
                div.flex.flex-row.space-x-1.justify-center
                    div.w-1.h-1.bg-white.border-2.border-black.rounded-full
                    div.w-1.h-1.bg-white.border-2.border-black.rounded-full
                    div.w-1.h-1.bg-white.border-2.border-black.rounded-full
            ...
            TransitionsPopUp
                MenuItems.absolute.top-16.right-2.bg-white.bg-opacity-90.drop-shadow-standard.rounded-md.py-2.px-6
                    ...
                    MenuItem(v-if="permissions['ADMIN']")
                        div(@click="editDeal").flex.justify-center.items-center.px-1.py-1.cursor-pointer.border-b.border-gray-400.text-lg.font-normal.hover_underline Item Deal
                    MenuItem
