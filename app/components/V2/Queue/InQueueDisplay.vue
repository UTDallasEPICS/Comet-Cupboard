...
div.min-w-72.lg_w-full.flex.flex-col.flex-grow.border-2.border-utd-green.rounded-2xl.overflow-auto.bg-white
    ...
    div.text-utd-green.flex.items-center.justify-center.text-xl.lg_text-5xl.font-bold.font-montserrat.w-full.h-10.lg_h-20
        p In Queue
    
    //- No matter what if the queue is empty, display a message that it is empty
    div(v-if="queue.length == 0" class="w-11/12").bg-cupboardv2-2elg.font-bold.font-montserrat.flex.items-center.justify-center.ml-auto.mr-auto.rounded-xl.text-center.text-base.lg_text-5xl.h-72.lg_h-96
    ...
    div(v-else-if="permissions['VERIFY_CART']" class="w-11/12").bg-cupboardv2-2elg.overflow-auto.mx-auto.rounded-xl.h-72.lg_h-96
    ...
    div(v-else class="w-11/12").bg-cupboardv2-2elg.flex.flex-col.items-center.justify-center.h-9.lg_h-24.rounded-2xl.mx-auto.text-xl.lg_text-5xl.font-bold.font-montserrat
