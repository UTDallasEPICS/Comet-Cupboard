                ...
                <div class="flex flex-col gap-4">
                    <UCard>
                        ...
                        <div class="space-y-3">
                            ...
                            <div
                                v-for="item in [...bagItems, ...currentBagItems]"
                                :key="item.itemID"
                                class="flex items-center gap-3 rounded bg-gray-100 p-3"
                            >
                                <img
                                    v-if="item.imgName"
...
const incrementStepper = () => { active.value++ }
const decrementStepper = () => { active.value-- }
