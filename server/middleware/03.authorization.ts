...
apiAccessMap.get("DELETE")?.set("/api/item", AccessLevel.VOLUNTEER)
apiAccessMap.get("POST")?.set("/api/item", AccessLevel.VOLUNTEER)
apiAccessMap.get("PUT")?.set("/api/item", AccessLevel.VOLUNTEER)
apiAccessMap.get("GET")?.set("/api/item", AccessLevel.VOLUNTEER)
